...
class SteamAuth implements SteamAuthInterface
{
    ...
    public function validate(): bool
    {
        ...
        $response = $this->guzzleClient->request('POST', Config::get('steam-auth.proxy_gateway') === false ? self::OPENID_URL : Config::get('steam-auth.proxy_gateway'), $requestOptions);
    ...
    public function parseInfo(): void
    {
        ...
        $response = $this->guzzleClient->request(
            'GET',
            sprintf(Config::get('steam-auth.steam_info_gateway') === false ? self::STEAM_INFO_URL : Config::get('steam-auth.steam_info_gateway'), Config::get('steam-auth.api_key'), $this->steamId)
        );
